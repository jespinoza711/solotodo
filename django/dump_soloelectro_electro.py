...
for name in model_base_names:
    ...
    for old_product in old_products:
        ...
        if rname == 'Television' and old_product['fields']['stype'] == 2:
            continue
        ...
        new_product['fields']['picture'] = product_fields['picture'].replace('notebook_pics', 'electro')
        new_product['model'] = 'electro.' + rname
