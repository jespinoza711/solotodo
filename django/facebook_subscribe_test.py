...
def test_new_user_can_subscribe_to_product_without_existing_facebook_session():
    facebook_user_name = 'Dexter Morgan'
    email, password = create_facebook_test_user(facebook_user_name)

    driver = webdriver.Chrome()

    driver.get(settings.SERVER_NAME + '/products/2811-samsung-un40d5500/')

    subscribe_button = driver.find_element_by_id('id_subscribe_link')
...
def main():
    test_new_user_can_subscribe_to_product_without_existing_facebook_session()
