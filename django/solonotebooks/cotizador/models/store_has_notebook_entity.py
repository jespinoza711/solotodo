...
from solonotebooks.cotizador.models import Notebook, Store, StoreHasNotebook
from utils import prettyPrice

class StoreHasNotebookEntity(models.Model):
    ...
    shn = models.ForeignKey(StoreHasNotebook, null = True, blank = True)
    ...
    class Meta:
        app_label = 'cotizador'
        verbose_name = 'Store has notebook entity' 
