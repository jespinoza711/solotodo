...
admin.site.register(AdvertisementImpressionPerDay)
...
excludes = ['ptype', 'shp', 'week_visitor_count', 'week_discount', 'long_description', 'similar_products', 'sponsored_shp', 'week_external_visits', 'display_name', 'part_number', 'created_by', 'url', 'review_url']
...
admin.site.register(StorageDriveBrand)
admin.site.register(StorageDriveBuffer)
admin.site.register(StorageDriveBus)
admin.site.register(StorageDriveCapacity)
admin.site.register(StorageDriveFamily)
admin.site.register(StorageDriveLine)
admin.site.register(StorageDriveRpm)
admin.site.register(StorageDriveSize)
admin.site.register(StorageDriveType)
admin.site.register(StorageDrive, ProductAdmin)

admin.site.register(PowerSupplyBrand)
admin.site.register(PowerSupplyCertification)
admin.site.register(PowerSupplyHasPowerConnector)
admin.site.register(PowerSupplyLine)
admin.site.register(PowerSupplyPower)
admin.site.register(PowerSupplyPowerConnector)
admin.site.register(PowerSupplySize)
admin.site.register(PowerSupply, ProductAdmin)

admin.site.register(ComputerCaseFan)
admin.site.register(ComputerCaseBrand)
admin.site.register(ComputerCaseFanDistribution)
admin.site.register(ComputerCaseMotherboardFormat)
admin.site.register(ComputerCasePowerSupply)
admin.site.register(ComputerCasePowerSupplyPosition)
admin.site.register(ComputerCase, ProductAdmin)
