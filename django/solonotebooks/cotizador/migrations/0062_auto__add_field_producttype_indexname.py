...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductType.indexname'
        db.add_column('cotizador_producttype', 'indexname', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ProductType.indexname'
        db.delete_column('cotizador_producttype', 'indexname')
