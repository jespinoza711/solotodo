...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cotizador_cellphone', (
            ...
            ('records_video', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('plays_mp3', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('has_bluetooth', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('has_wifi', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('has_3g', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('has_gps', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('has_headphones_ouput', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ...
            ('processor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.CellphoneProcessor'])),
        ))
        ...
        db.create_table('cotizador_cellphonescreen', (
            ...
            ('is_touch', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ))
        ...
        # Adding field 'Cell.phone'
        db.add_column('cotizador_cell', 'phone', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.Cellphone']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Cell.phone'
        db.delete_column('cotizador_cell', 'phone_id')
    ...
    models = {
        ...
        'cotizador.cellphone': {
            ...
            'has_headphones_ouput': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            ...
            'processor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cotizador.CellphoneProcessor']"}),
