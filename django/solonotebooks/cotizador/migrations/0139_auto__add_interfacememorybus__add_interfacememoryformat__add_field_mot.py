...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MotherboardMemoryType.itype'
        db.add_column('cotizador_motherboardmemorytype', 'itype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.InterfaceMemoryBus'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MotherboardMemoryType.itype'
        db.delete_column('cotizador_motherboardmemorytype', 'itype_id')
