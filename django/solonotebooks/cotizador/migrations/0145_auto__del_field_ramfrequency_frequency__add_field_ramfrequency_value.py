...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RamFrequency.frequency'
        db.delete_column('cotizador_ramfrequency', 'frequency')

        # Adding field 'RamFrequency.value'
        db.add_column('cotizador_ramfrequency', 'value', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'RamFrequency.frequency'
        db.add_column('cotizador_ramfrequency', 'frequency', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'RamFrequency.value'
        db.delete_column('cotizador_ramfrequency', 'value')
    ...
    models = {
        ...
        'cotizador.ramtotalcapacity': {
            'Meta': {'object_name': 'RamTotalCapacity'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'value': ('django.db.models.fields.IntegerField', [], {})
        },
