...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RamVoltage.value'
        db.alter_column('cotizador_ramvoltage', 'value', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'RamVoltage.value'
        db.alter_column('cotizador_ramvoltage', 'value', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=1))
    ...
    models = {
        ...
        'cotizador.ram': {
            ...
            'is_ecc': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'is_fully_buffered': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
