...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LogLostModel'
        db.create_table('cotizador_loglostmodel', (
        ...
        db.send_create_signal('cotizador', ['LogLostModel'])

        # Adding model 'LogNewModel'
        db.create_table('cotizador_lognewmodel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shn', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.StoreHasNotebook'])),
            ('log_entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.LogEntry'])),
        ))
        db.send_create_signal('cotizador', ['LogNewModel'])

        # Adding model 'LogChangeNotebookPrice'
        db.create_table('cotizador_logchangenotebookprice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('cotizador', ['LogChangeNotebookPrice'])

        # Adding model 'LogReviveModel'
        db.create_table('cotizador_logrevivemodel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shn', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.StoreHasNotebook'])),
            ('log_entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.LogEntry'])),
        ))
        db.send_create_signal('cotizador', ['LogReviveModel'])

        # Adding model 'LogChangeModelPrice'
        db.create_table('cotizador_logchangemodelprice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shn', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.StoreHasNotebook'])),
            ('log_entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.LogEntry'])),
            ('old_price', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal('cotizador', ['LogChangeModelPrice'])

        # Adding model 'LogLostNotebook'
        db.create_table('cotizador_loglostnotebook', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('notebook', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Notebook'])),
            ('log_entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.LogEntry'])),
        ))
        db.send_create_signal('cotizador', ['LogLostNotebook'])

        # Adding model 'LogReviveNotebook'
        db.create_table('cotizador_logrevivenotebook', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('notebook', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Notebook'])),
            ('log_entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.LogEntry'])),
        ))
        db.send_create_signal('cotizador', ['LogReviveNotebook'])


    def backwards(self, orm):
        
        # Deleting model 'LogLostModel'
        db.delete_table('cotizador_loglostmodel')

        # Deleting model 'LogNewModel'
        db.delete_table('cotizador_lognewmodel')

        # Deleting model 'LogChangeNotebookPrice'
        db.delete_table('cotizador_logchangenotebookprice')

        # Deleting model 'LogReviveModel'
        db.delete_table('cotizador_logrevivemodel')

        # Deleting model 'LogChangeModelPrice'
        db.delete_table('cotizador_logchangemodelprice')

        # Deleting model 'LogLostNotebook'
        db.delete_table('cotizador_loglostnotebook')

        # Deleting model 'LogReviveNotebook'
        db.delete_table('cotizador_logrevivenotebook')
