...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('cotizador_operatingsystembrand', 'cotizador_notebookoperatingsystembrand')

        # Deleting model 'OperatingSystemFamily'
        db.rename_table('cotizador_operatingsystemfamily', 'cotizador_notebookoperatingsystemfamily')

        # Deleting model 'OperatingSystem'
        db.rename_table('cotizador_operatingsystem', 'cotizador_notebookoperatingsystem')

        # Deleting model 'OperatingSystemLanguage'
        db.rename_table('cotizador_operatingsystemlanguage', 'cotizador_notebookoperatingsystemlanguage')

        # Changing field 'Notebook.operating_system'
        db.alter_column('cotizador_notebook', 'operating_system_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.NotebookOperatingSystem']))
    
    
    def backwards(self, orm):
        
        # Deleting model 'OperatingSystemBrand'
        db.rename_table('cotizador_notebookoperatingsystembrand', 'cotizador_operatingsystembrand')

        # Deleting model 'OperatingSystemFamily'
        db.rename_table('cotizador_notebookoperatingsystemfamily', 'cotizador_operatingsystemfamily')

        # Deleting model 'OperatingSystem'
        db.rename_table('cotizador_notebookoperatingsystem', 'cotizador_operatingsystem')

        # Deleting model 'OperatingSystemLanguage'
        db.rename_table('cotizador_notebookoperatingsystemlanguage', 'cotizador_operatingsystemlanguage')

        # Changing field 'Notebook.operating_system'
        db.alter_column('cotizador_notebook', 'operating_system_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.OperatingSystem']))
