...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MailLostNotebook'
        db.create_table('cotizador_maillostnotebook', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subscription', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.NotebookSubscription'])),
            ('log', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.LogLostNotebook'])),
            ('success', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ))
        db.send_create_signal('cotizador', ['MailLostNotebook'])

        # Adding model 'MailReviveNotebook'
        db.create_table('cotizador_mailrevivenotebook', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subscription', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.NotebookSubscription'])),
            ('log', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.LogReviveNotebook'])),
            ('success', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ))
        db.send_create_signal('cotizador', ['MailReviveNotebook'])


    def backwards(self, orm):
        
        # Deleting model 'MailLostNotebook'
        db.delete_table('cotizador_maillostnotebook')

        # Deleting model 'MailReviveNotebook'
        db.delete_table('cotizador_mailrevivenotebook')
