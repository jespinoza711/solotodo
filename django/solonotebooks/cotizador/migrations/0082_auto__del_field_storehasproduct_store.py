...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StoreHasProduct.store'
        db.delete_column('cotizador_storehasproduct', 'store_id')


    def backwards(self, orm):
        
        # Adding field 'StoreHasProduct.store'
        db.add_column('cotizador_storehasproduct', 'store', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.Store']), keep_default=False)
