...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VideoCardGpu.tdmark_vantage_score'
        db.add_column('cotizador_videocardgpu', 'tdmark_vantage_score', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'VideoCardGpu.tdmark_11_score'
        db.add_column('cotizador_videocardgpu', 'tdmark_11_score', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'VideoCardGpu.tdmark_06_score'
        db.add_column('cotizador_videocardgpu', 'tdmark_06_score', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'VideoCardGpu.tdmark_id'
        db.add_column('cotizador_videocardgpu', 'tdmark_id', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'VideoCardGpu.tdmark_vantage_score'
        db.delete_column('cotizador_videocardgpu', 'tdmark_vantage_score')

        # Deleting field 'VideoCardGpu.tdmark_11_score'
        db.delete_column('cotizador_videocardgpu', 'tdmark_11_score')

        # Deleting field 'VideoCardGpu.tdmark_06_score'
        db.delete_column('cotizador_videocardgpu', 'tdmark_06_score')

        # Deleting field 'VideoCardGpu.tdmark_id'
        db.delete_column('cotizador_videocardgpu', 'tdmark_id')
