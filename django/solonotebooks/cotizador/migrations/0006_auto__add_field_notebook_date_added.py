...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Notebook.date_added'
        db.add_column('cotizador_notebook', 'date_added', self.gf('django.db.models.fields.DateField')(default=datetime.date(2010, 6, 3)), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Notebook.date_added'
        db.delete_column('cotizador_notebook', 'date_added')
