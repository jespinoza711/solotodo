...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'VideoCardGpu.power_connectors'
        db.delete_column('cotizador_videocardgpu', 'power_connectors_id')


    def backwards(self, orm):
        
        # Adding field 'VideoCardGpu.power_connectors'
        db.add_column('cotizador_videocardgpu', 'power_connectors', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.VideoCardGpuPowerConnector']), keep_default=False)
