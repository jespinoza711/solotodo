...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Product.publicized_offer'
        db.delete_column('cotizador_product', 'publicized_offer_id')


    def backwards(self, orm):
        
        # Adding field 'Product.publicized_offer'
        db.add_column('cotizador_product', 'publicized_offer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ntbk', null=True, to=orm['cotizador.StoreHasProductEntity'], blank=True), keep_default=False)
