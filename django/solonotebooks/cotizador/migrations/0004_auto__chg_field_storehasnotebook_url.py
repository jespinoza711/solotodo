...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StoreHasNotebook.url'
        db.alter_column('cotizador_storehasnotebook', 'url', self.gf('django.db.models.fields.TextField')())
    
    
    def backwards(self, orm):
        
        # Changing field 'StoreHasNotebook.url'
        db.alter_column('cotizador_storehasnotebook', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
