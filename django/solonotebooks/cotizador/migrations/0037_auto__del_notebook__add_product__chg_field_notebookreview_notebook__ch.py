...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('cotizador_notebook', 'cotizador_product')

        # Changing field 'NotebookReview.notebook'
        db.alter_column('cotizador_notebookreview', 'notebook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Product']))

        # Changing field 'StoreHasProduct.notebook'
        db.alter_column('cotizador_storehasproduct', 'notebook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Product'], null=True, blank=True))

        # Changing field 'NotebookVisit.notebook'
        db.alter_column('cotizador_notebookvisit', 'notebook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Product']))

        # Changing field 'LogChangeNotebookPrice.notebook'
        db.alter_column('cotizador_logchangenotebookprice', 'notebook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Product']))

        # Changing field 'LogLostNotebook.notebook'
        db.alter_column('cotizador_loglostnotebook', 'notebook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Product']))

        # Changing field 'NotebookPriceChange.notebook'
        db.alter_column('cotizador_notebookpricechange', 'notebook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Product']))

        # Changing field 'NotebookPicture.notebook'
        db.alter_column('cotizador_notebookpicture', 'notebook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Product']))

        # Changing field 'NotebookComment.notebook'
        db.alter_column('cotizador_notebookcomment', 'notebook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Product']))

        # Changing field 'LogReviveNotebook.notebook'
        db.alter_column('cotizador_logrevivenotebook', 'notebook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Product']))

        # Changing field 'NotebookSubscription.notebook'
        db.alter_column('cotizador_notebooksubscription', 'notebook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Product']))
    
    
    def backwards(self, orm):
    
        db.rename_table('cotizador_product', 'cotizador_notebook')
        
        # Changing field 'NotebookReview.notebook'
        db.alter_column('cotizador_notebookreview', 'notebook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Notebook']))

        # Changing field 'StoreHasProduct.notebook'
        db.alter_column('cotizador_storehasproduct', 'notebook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Notebook'], null=True, blank=True))

        # Changing field 'NotebookVisit.notebook'
        db.alter_column('cotizador_notebookvisit', 'notebook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Notebook']))

        # Changing field 'LogChangeNotebookPrice.notebook'
        db.alter_column('cotizador_logchangenotebookprice', 'notebook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Notebook']))

        # Changing field 'LogLostNotebook.notebook'
        db.alter_column('cotizador_loglostnotebook', 'notebook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Notebook']))

        # Changing field 'NotebookPriceChange.notebook'
        db.alter_column('cotizador_notebookpricechange', 'notebook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Notebook']))

        # Changing field 'NotebookPicture.notebook'
        db.alter_column('cotizador_notebookpicture', 'notebook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Notebook']))

        # Changing field 'NotebookComment.notebook'
        db.alter_column('cotizador_notebookcomment', 'notebook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Notebook']))

        # Changing field 'LogReviveNotebook.notebook'
        db.alter_column('cotizador_logrevivenotebook', 'notebook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Notebook']))

        # Changing field 'NotebookSubscription.notebook'
        db.alter_column('cotizador_notebooksubscription', 'notebook_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Notebook']))
