...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MotherboardNorthbridge.graphics'
        db.add_column('cotizador_motherboardnorthbridge', 'graphics', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.MotherboardGraphics']), keep_default=False)

        # Adding field 'MotherboardNorthbridgeFamily.socket'
        db.add_column('cotizador_motherboardnorthbridgefamily', 'socket', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.MotherboardSocket']), keep_default=False)

        # Deleting field 'Motherboard.graphics'
        db.delete_column('cotizador_motherboard', 'graphics_id')

        # Deleting field 'Motherboard.socket'
        db.delete_column('cotizador_motherboard', 'socket_id')


    def backwards(self, orm):
        
        # Deleting field 'MotherboardNorthbridge.graphics'
        db.delete_column('cotizador_motherboardnorthbridge', 'graphics_id')

        # Deleting field 'MotherboardNorthbridgeFamily.socket'
        db.delete_column('cotizador_motherboardnorthbridgefamily', 'socket_id')

        # Adding field 'Motherboard.graphics'
        db.add_column('cotizador_motherboard', 'graphics', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.MotherboardGraphics']), keep_default=False)

        # Adding field 'Motherboard.socket'
        db.add_column('cotizador_motherboard', 'socket', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.MotherboardSocket']), keep_default=False)
