...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NotebookSubscription.is_active'
        db.add_column('cotizador_notebooksubscription', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NotebookSubscription.is_active'
        db.delete_column('cotizador_notebooksubscription', 'is_active')
