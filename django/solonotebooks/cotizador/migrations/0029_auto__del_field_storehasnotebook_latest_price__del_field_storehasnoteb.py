...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StoreHasNotebook.latest_price'
        db.delete_column('cotizador_storehasnotebook', 'latest_price')

        # Deleting field 'StoreHasNotebook.is_available'
        db.delete_column('cotizador_storehasnotebook', 'is_available')

        # Adding field 'StoreHasNotebook.shne'
        db.add_column('cotizador_storehasnotebook', 'shne', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.StoreHasNotebookEntity'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'StoreHasNotebook.latest_price'
        db.add_column('cotizador_storehasnotebook', 'latest_price', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'StoreHasNotebook.is_available'
        db.add_column('cotizador_storehasnotebook', 'is_available', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'StoreHasNotebook.shne'
        db.delete_column('cotizador_storehasnotebook', 'shne_id')
