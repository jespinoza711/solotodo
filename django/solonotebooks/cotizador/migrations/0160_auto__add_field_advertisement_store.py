...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Advertisement.store'
        db.add_column('cotizador_advertisement', 'store', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Store'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Advertisement.store'
        db.delete_column('cotizador_advertisement', 'store_id')
