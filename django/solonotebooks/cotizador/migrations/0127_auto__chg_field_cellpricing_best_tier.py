...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CellPricing.best_tier'
        db.alter_column('cotizador_cellpricing', 'best_tier_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.CellPricingTier'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'CellPricing.best_tier'
        db.alter_column('cotizador_cellpricing', 'best_tier_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.CellPricingTier']))
