...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ram.is_fully_buffered'
        db.add_column('cotizador_ram', 'is_fully_buffered', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ram.is_fully_buffered'
        db.delete_column('cotizador_ram', 'is_fully_buffered')
