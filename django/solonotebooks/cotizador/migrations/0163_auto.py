...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'AdvertisementImpression', fields ['date']
        db.create_index('cotizador_advertisementimpression', ['date'])


    def backwards(self, orm):
        
        # Removing index on 'AdvertisementImpression', fields ['date']
        db.delete_index('cotizador_advertisementimpression', ['date'])
