...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VideoCardBus.bus'
        db.add_column('cotizador_videocardbus', 'bus', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.InterfaceCardBus']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'VideoCardBus.bus'
        db.delete_column('cotizador_videocardbus', 'bus_id')
