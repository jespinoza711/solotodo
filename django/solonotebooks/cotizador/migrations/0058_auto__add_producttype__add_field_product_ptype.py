...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.ptype'
        db.add_column('cotizador_product', 'ptype', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cotizador.ProductType']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Product.ptype'
        db.delete_column('cotizador_product', 'ptype_id')
