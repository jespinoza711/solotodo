...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.date_added'
        db.alter_column('cotizador_product', 'date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Product.date_added'
        db.alter_column('cotizador_product', 'date_added', self.gf('django.db.models.fields.DateField')())
