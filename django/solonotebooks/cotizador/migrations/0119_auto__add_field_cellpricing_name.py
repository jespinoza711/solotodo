...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CellPricing.name'
        db.add_column('cotizador_cellpricing', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CellPricing.name'
        db.delete_column('cotizador_cellpricing', 'name')
