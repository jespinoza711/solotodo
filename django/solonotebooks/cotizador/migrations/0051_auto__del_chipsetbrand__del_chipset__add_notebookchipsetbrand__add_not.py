...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('cotizador_chipsetbrand', 'cotizador_notebookchipsetbrand')

        # Deleting model 'Chipset'
        db.rename_table('cotizador_chipset', 'cotizador_notebookchipset')

        # Changing field 'Notebook.chipset'
        db.alter_column('cotizador_notebook', 'chipset_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.NotebookChipset']))
    
    
    def backwards(self, orm):

        # Deleting model 'ChipsetBrand'
        db.rename_table('cotizador_notebookchipsetbrand', 'cotizador_chipsetbrand')

        # Deleting model 'Chipset'
        db.rename_table('cotizador_notebookchipset', 'cotizador_chipset')

        # Changing field 'Notebook.chipset'
        db.alter_column('cotizador_notebook', 'chipset_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Chipset']))
