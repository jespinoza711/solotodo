...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Screen.refresh_rate'
        db.add_column('cotizador_screen', 'refresh_rate', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.ScreenRefreshRate']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Screen.refresh_rate'
        db.delete_column('cotizador_screen', 'refresh_rate_id')
