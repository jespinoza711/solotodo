...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cotizador_ram', (
            ...
            ('latency_cl', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.RamLatencyCl'])),
            ('latency_trcd', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.RamLatencyTrcd'])),
            ('latency_trp', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.RamLatencyTrp'])),
            ('latency_tras', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.RamLatencyTras'])),
        ))
    ...
    models = {
        ...
        'cotizador.ram': {
            ...
            'latency_cl': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cotizador.RamLatencyCl']"}),
            'latency_tras': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cotizador.RamLatencyTras']"}),
            'latency_trcd': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cotizador.RamLatencyTrcd']"}),
            'latency_trp': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cotizador.RamLatencyTrp']"}),
