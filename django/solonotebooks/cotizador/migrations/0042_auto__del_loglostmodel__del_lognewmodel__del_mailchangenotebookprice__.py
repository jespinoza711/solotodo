...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'LogLostModel'
        db.rename_table('cotizador_loglostmodel', 'cotizador_loglostentity')

        # Deleting model 'LogNewModel'
        db.rename_table('cotizador_lognewmodel', 'cotizador_lognewentity')

        # Deleting model 'MailChangeNotebookPrice'
        db.rename_table('cotizador_mailchangenotebookprice', 'cotizador_mailchangeproductprice')

        # Deleting model 'LogChangeNotebookPrice'
        db.rename_table('cotizador_logchangenotebookprice', 'cotizador_logchangeproductprice')

        # Deleting model 'LogReviveModel'
        db.rename_table('cotizador_logrevivemodel', 'cotizador_logreviveentity')

        # Deleting model 'LogChangeModelPrice'
        db.rename_table('cotizador_logchangemodelprice', 'cotizador_logchangeentityprice')

        # Deleting model 'LogLostNotebook'
        db.rename_table('cotizador_loglostnotebook', 'cotizador_loglostproduct')

        # Deleting model 'MailReviveNotebook'
        db.rename_table('cotizador_mailrevivenotebook', 'cotizador_mailreviveproduct')

        # Deleting model 'MailLostNotebook'
        db.rename_table('cotizador_maillostnotebook', 'cotizador_maillostproduct')

        # Deleting model 'LogReviveNotebook'
        db.rename_table('cotizador_logrevivenotebook', 'cotizador_logreviveproduct')

        # Deleting model 'NotebookSubscription'
        db.rename_table('cotizador_notebooksubscription', 'cotizador_productsubscription')

        
    def backwards(self, orm):
        
        # Deleting model 'LogLostModel'
        db.rename_table('cotizador_loglostentity', 'cotizador_loglostmodel')

        # Deleting model 'LogNewModel'
        db.rename_table('cotizador_lognewentity', 'cotizador_lognewmodel')

        # Deleting model 'MailChangeNotebookPrice'
        db.rename_table('cotizador_mailchangeproductprice', 'cotizador_mailchangenotebookprice')

        # Deleting model 'LogChangeNotebookPrice'
        db.rename_table('cotizador_logchangeproductprice', 'cotizador_logchangenotebookprice')

        # Deleting model 'LogReviveModel'
        db.rename_table('cotizador_logreviveentity', 'cotizador_logrevivemodel')

        # Deleting model 'LogChangeModelPrice'
        db.rename_table('cotizador_logchangeentityprice', 'cotizador_logchangemodelprice')

        # Deleting model 'LogLostNotebook'
        db.rename_table('cotizador_loglostproduct', 'cotizador_loglostnotebook')

        # Deleting model 'MailReviveNotebook'
        db.rename_table('cotizador_mailreviveproduct', 'cotizador_mailrevivenotebook')

        # Deleting model 'MailLostNotebook'
        db.rename_table('cotizador_maillostproduct', 'cotizador_maillostnotebook')

        # Deleting model 'LogReviveNotebook'
        db.rename_table('cotizador_logreviveproduct', 'cotizador_logrevivenotebook')

        # Deleting model 'NotebookSubscription'
        db.rename_table('cotizador_productsubscription', 'cotizador_notebooksubscription')
