...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.sponsored_shp'
        db.add_column('cotizador_product', 'sponsored_shp', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sponsored_product', null=True, to=orm['cotizador.StoreHasProduct']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.sponsored_shp'
        db.delete_column('cotizador_product', 'sponsored_shp_id')
