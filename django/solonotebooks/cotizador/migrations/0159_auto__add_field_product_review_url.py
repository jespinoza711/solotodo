...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.review_url'
        db.add_column('cotizador_product', 'review_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.review_url'
        db.delete_column('cotizador_product', 'review_url')
