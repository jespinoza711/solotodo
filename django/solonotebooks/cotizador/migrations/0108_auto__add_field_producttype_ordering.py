...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductType.ordering'
        db.add_column('cotizador_producttype', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductType.ordering'
        db.delete_column('cotizador_producttype', 'ordering')
