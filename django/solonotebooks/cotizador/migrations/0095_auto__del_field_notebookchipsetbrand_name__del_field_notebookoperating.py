...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NotebookChipsetBrand.name'
        db.delete_column('cotizador_notebookchipsetbrand', 'name')

        # Deleting field 'NotebookOperatingSystemBrand.name'
        db.delete_column('cotizador_notebookoperatingsystembrand', 'name')

        # Deleting field 'NotebookBrand.name'
        db.delete_column('cotizador_notebookbrand', 'name')

        # Deleting field 'NotebookWifiCardBrand.name'
        db.delete_column('cotizador_notebookwificardbrand', 'name')

        # Deleting field 'NotebookVideoCardBrand.name'
        db.delete_column('cotizador_notebookvideocardbrand', 'name')

        # Deleting field 'VideoCardBrand.name'
        db.delete_column('cotizador_videocardbrand', 'name')

        # Deleting field 'VideoCardGpuBrand.name'
        db.delete_column('cotizador_videocardgpubrand', 'name')

        # Deleting field 'ScreenBrand.name'
        db.delete_column('cotizador_screenbrand', 'name')

        # Deleting field 'ProcessorBrand.name'
        db.delete_column('cotizador_processorbrand', 'name')

        # Deleting field 'NotebookProcessorBrand.name'
        db.delete_column('cotizador_notebookprocessorbrand', 'name')


    def backwards(self, orm):
        
        # Adding field 'NotebookChipsetBrand.name'
        db.add_column('cotizador_notebookchipsetbrand', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'NotebookOperatingSystemBrand.name'
        db.add_column('cotizador_notebookoperatingsystembrand', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'NotebookBrand.name'
        db.add_column('cotizador_notebookbrand', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'NotebookWifiCardBrand.name'
        db.add_column('cotizador_notebookwificardbrand', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'NotebookVideoCardBrand.name'
        db.add_column('cotizador_notebookvideocardbrand', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'VideoCardBrand.name'
        db.add_column('cotizador_videocardbrand', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'VideoCardGpuBrand.name'
        db.add_column('cotizador_videocardgpubrand', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'ScreenBrand.name'
        db.add_column('cotizador_screenbrand', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'ProcessorBrand.name'
        db.add_column('cotizador_processorbrand', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'NotebookProcessorBrand.name'
        db.add_column('cotizador_notebookprocessorbrand', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)
