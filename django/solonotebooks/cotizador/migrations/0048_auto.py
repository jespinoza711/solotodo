...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field notebooks on 'ProductComparisonList'
        db.delete_table('cotizador_productcomparisonlist_notebooks')
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field notebooks on 'ProductComparisonList'
        db.create_table('cotizador_productcomparisonlist_notebooks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('productcomparisonlist', models.ForeignKey(orm['cotizador.productcomparisonlist'], null=False)),
            ('product', models.ForeignKey(orm['cotizador.product'], null=False))
        ))
        db.create_unique('cotizador_productcomparisonlist_notebooks', ['productcomparisonlist_id', 'product_id'])
