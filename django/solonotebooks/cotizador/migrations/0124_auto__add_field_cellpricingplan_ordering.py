...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CellPricingPlan.ordering'
        db.add_column('cotizador_cellpricingplan', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CellPricingPlan.ordering'
        db.delete_column('cotizador_cellpricingplan', 'ordering')
