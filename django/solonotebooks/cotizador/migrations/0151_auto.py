...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'ProductVisit', fields ['date']
        db.create_index('cotizador_productvisit', ['date'])


    def backwards(self, orm):
        
        # Removing index on 'ProductVisit', fields ['date']
        db.delete_index('cotizador_productvisit', ['date'])
