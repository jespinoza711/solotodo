...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProcessorSocket.num_pins'
        db.delete_column('cotizador_processorsocket', 'num_pins')

        # Deleting field 'ProcessorSocket.name'
        db.delete_column('cotizador_processorsocket', 'name')


    def backwards(self, orm):
        
        # Adding field 'ProcessorSocket.num_pins'
        db.add_column('cotizador_processorsocket', 'num_pins', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'ProcessorSocket.name'
        db.add_column('cotizador_processorsocket', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)
