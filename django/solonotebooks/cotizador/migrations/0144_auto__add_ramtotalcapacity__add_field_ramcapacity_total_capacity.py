...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RamCapacity.total_capacity'
        db.add_column('cotizador_ramcapacity', 'total_capacity', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.RamTotalCapacity']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'RamCapacity.total_capacity'
        db.delete_column('cotizador_ramcapacity', 'total_capacity_id')
