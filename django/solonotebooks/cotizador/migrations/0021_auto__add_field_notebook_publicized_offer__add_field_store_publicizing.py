...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Notebook.publicized_offer'
        db.add_column('cotizador_notebook', 'publicized_offer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ntbk', null=True, to=orm['cotizador.StoreHasNotebook']), keep_default=False)

        # Adding field 'Store.publicizing_user'
        db.add_column('cotizador_store', 'publicizing_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Notebook.publicized_offer'
        db.delete_column('cotizador_notebook', 'publicized_offer_id')

        # Deleting field 'Store.publicizing_user'
        db.delete_column('cotizador_store', 'publicizing_user_id')
    ...
    models = {
        ...
        'cotizador.store': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'picture': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'publicizing_user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
