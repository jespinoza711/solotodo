...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MotherboardFormat.format'
        db.alter_column('cotizador_motherboardformat', 'format_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cotizador.InterfaceMotherboardFormat']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'MotherboardFormat.format'
        db.alter_column('cotizador_motherboardformat', 'format_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.InterfaceMotherboardFormat'], null=True))
