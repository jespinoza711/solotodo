...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CellPricingTier.ordering_cellphone_price'
        db.add_column('cotizador_cellpricingtier', 'ordering_cellphone_price', self.gf('django.db.models.fields.BigIntegerField')(default=0), keep_default=False)

        # Adding field 'CellPricingTier.ordering_three_month_price'
        db.add_column('cotizador_cellpricingtier', 'ordering_three_month_price', self.gf('django.db.models.fields.BigIntegerField')(default=0), keep_default=False)

        # Adding field 'CellPricingTier.ordering_six_month_price'
        db.add_column('cotizador_cellpricingtier', 'ordering_six_month_price', self.gf('django.db.models.fields.BigIntegerField')(default=0), keep_default=False)

        # Adding field 'CellPricingTier.ordering_twelve_month_price'
        db.add_column('cotizador_cellpricingtier', 'ordering_twelve_month_price', self.gf('django.db.models.fields.BigIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CellPricingTier.ordering_cellphone_price'
        db.delete_column('cotizador_cellpricingtier', 'ordering_cellphone_price')

        # Deleting field 'CellPricingTier.ordering_three_month_price'
        db.delete_column('cotizador_cellpricingtier', 'ordering_three_month_price')

        # Deleting field 'CellPricingTier.ordering_six_month_price'
        db.delete_column('cotizador_cellpricingtier', 'ordering_six_month_price')

        # Deleting field 'CellPricingTier.ordering_twelve_month_price'
        db.delete_column('cotizador_cellpricingtier', 'ordering_twelve_month_price')
