...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NotebookComparisonList'
        db.create_table('cotizador_notebookcomparisonlist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('cotizador', ['NotebookComparisonList'])

        # Adding M2M table for field notebooks on 'NotebookComparisonList'
        db.create_table('cotizador_notebookcomparisonlist_notebooks', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('notebookcomparisonlist', models.ForeignKey(orm['cotizador.notebookcomparisonlist'], null=False)),
            ('notebook', models.ForeignKey(orm['cotizador.notebook'], null=False))
        ))
        db.create_unique('cotizador_notebookcomparisonlist_notebooks', ['notebookcomparisonlist_id', 'notebook_id'])


    def backwards(self, orm):
        
        # Deleting model 'NotebookComparisonList'
        db.delete_table('cotizador_notebookcomparisonlist')

        # Removing M2M table for field notebooks on 'NotebookComparisonList'
        db.delete_table('cotizador_notebookcomparisonlist_notebooks')
