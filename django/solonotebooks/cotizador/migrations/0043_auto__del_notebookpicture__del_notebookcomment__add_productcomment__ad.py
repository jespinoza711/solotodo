...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('cotizador_notebookpicture', 'cotizador_productpicture')

        # Deleting model 'NotebookComment'
        db.rename_table('cotizador_notebookcomment', 'cotizador_productcomment')

        # Deleting field 'LogNewEntity.shn'
        db.rename_column('cotizador_lognewentity', 'shn_id', 'shpe_id')

        # Deleting field 'LogLostProduct.notebook'
        db.rename_column('cotizador_loglostproduct', 'notebook_id', 'product_id')

        # Deleting field 'StoreHasProduct.notebook'
        db.rename_column('cotizador_storehasproduct', 'notebook_id', 'product_id')

        # Deleting field 'LogChangeProductPrice.notebook'
        db.rename_column('cotizador_logchangeproductprice', 'notebook_id', 'product_id')

        # Deleting field 'LogReviveEntity.shn'
        db.rename_column('cotizador_logreviveentity', 'shn_id', 'shpe_id')

        # Deleting field 'LogChangeEntityPrice.shn'
        db.rename_column('cotizador_logchangeentityprice', 'shn_id', 'shpe_id')

        # SI
        db.rename_column('cotizador_loglostentity', 'shn_id', 'shpe_id')

        # SI
        db.rename_column('cotizador_productsubscription', 'notebook_id', 'product_id')

        # SI
        db.rename_column('cotizador_logreviveproduct', 'notebook_id', 'product_id')
    
    def backwards(self, orm):
        
        # Deleting model 'NotebookPicture'
        db.rename_table('cotizador_productpicture', 'cotizador_notebookpicture')

        # Deleting model 'NotebookComment'
        db.rename_table('cotizador_productcomment', 'cotizador_notebookcomment')

        # Deleting field 'LogNewEntity.shn'
        db.rename_column('cotizador_lognewentity', 'shpe_id', 'shn_id')

        # Deleting field 'LogLostProduct.notebook'
        db.rename_column('cotizador_loglostproduct', 'product_id', 'notebook_id')

        # Deleting field 'StoreHasProduct.notebook'
        db.rename_column('cotizador_storehasproduct', 'product_id', 'notebook_id')

        # Deleting field 'LogChangeProductPrice.notebook'
        db.rename_column('cotizador_logchangeproductprice', 'product_id', 'notebook_id')

        # Deleting field 'LogReviveEntity.shn'
        db.rename_column('cotizador_logreviveentity', 'shpe_id', 'shn_id')

        # Deleting field 'LogChangeEntityPrice.shn'
        db.rename_column('cotizador_logchangeentityprice', 'shpe_id', 'shn_id')

        # Deleting field 'LogLostEntity.shn'
        db.rename_column('cotizador_loglostentity', 'shpe_id', 'shn_id')

        # Deleting field 'ProductSubscription.notebook'
        db.rename_column('cotizador_productsubscription', 'product_id', 'notebook_id')

        # Deleting field 'LogReviveProduct.notebook'
        db.rename_column('cotizador_logreviveproduct', 'product_id', 'notebook_id')
