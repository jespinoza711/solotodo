...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProcessorArchitecture.turbo_step'
        db.add_column('cotizador_processorarchitecture', 'turbo_step', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ProcessorArchitecture.turbo_step'
        db.delete_column('cotizador_processorarchitecture', 'turbo_step')
