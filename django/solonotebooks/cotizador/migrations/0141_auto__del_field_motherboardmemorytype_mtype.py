...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MotherboardMemoryType.mtype'
        db.delete_column('cotizador_motherboardmemorytype', 'mtype_id')


    def backwards(self, orm):
        
        # Adding field 'MotherboardMemoryType.mtype'
        db.add_column('cotizador_motherboardmemorytype', 'mtype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.InterfaceMemoryType'], null=True, blank=True), keep_default=False)
