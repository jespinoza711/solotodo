...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ScreenVideoPort.name'
        db.delete_column('cotizador_screenvideoport', 'name')

        # Deleting field 'VideoCardPort.name'
        db.delete_column('cotizador_videocardport', 'name')


    def backwards(self, orm):
        
        # Adding field 'ScreenVideoPort.name'
        db.add_column('cotizador_screenvideoport', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'VideoCardPort.name'
        db.add_column('cotizador_videocardport', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)
