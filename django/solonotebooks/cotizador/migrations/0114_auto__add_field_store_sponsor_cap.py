...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Store.sponsor_cap'
        db.add_column('cotizador_store', 'sponsor_cap', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Store.sponsor_cap'
        db.delete_column('cotizador_store', 'sponsor_cap')
