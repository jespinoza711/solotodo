...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MotherboardMemoryType.mtype'
        db.alter_column('cotizador_motherboardmemorytype', 'mtype_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.InterfaceMemoryType'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'MotherboardMemoryType.mtype'
        db.alter_column('cotizador_motherboardmemorytype', 'mtype_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.InterfaceMemoryType']))
    ...
    models = {
        ...
        'cotizador.motherboardmemorytype': {
            ...
            'mtype': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cotizador.InterfaceMemoryType']", 'null': 'True', 'blank': 'True'})
        },
