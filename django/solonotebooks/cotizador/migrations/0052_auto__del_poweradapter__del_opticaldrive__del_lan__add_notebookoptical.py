...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('cotizador_poweradapter', 'cotizador_notebookpoweradapter')

        # Deleting model 'OpticalDrive'
        db.rename_table('cotizador_opticaldrive', 'cotizador_notebookopticaldrive')

        # Deleting model 'Lan'
        db.rename_table('cotizador_lan', 'cotizador_notebooklan')

        # Changing field 'Notebook.power_adapter'
        db.alter_column('cotizador_notebook', 'power_adapter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.NotebookPowerAdapter']))

        # Changing field 'Notebook.optical_drive'
        db.alter_column('cotizador_notebook', 'optical_drive_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.NotebookOpticalDrive']))

        # Changing field 'Notebook.lan'
        db.alter_column('cotizador_notebook', 'lan_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.NotebookLan']))
    
    
    def backwards(self, orm):
        
        # Deleting model 'PowerAdapter'
        db.rename_table('cotizador_notebookpoweradapter', 'cotizador_poweradapter')

        # Deleting model 'OpticalDrive'
        db.rename_table('cotizador_notebookopticaldrive', 'cotizador_opticaldrive')

        # Deleting model 'Lan'
        db.rename_table('cotizador_notebooklan', 'cotizador_lan')
        
        # Changing field 'Notebook.power_adapter'
        db.alter_column('cotizador_notebook', 'power_adapter_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.PowerAdapter']))

        # Changing field 'Notebook.optical_drive'
        db.alter_column('cotizador_notebook', 'optical_drive_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.OpticalDrive']))

        # Changing field 'Notebook.lan'
        db.alter_column('cotizador_notebook', 'lan_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Lan']))
