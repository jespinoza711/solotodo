...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProcessorSocket.socket'
        db.add_column('cotizador_processorsocket', 'socket', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.InterfaceSocket']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProcessorSocket.socket'
        db.delete_column('cotizador_processorsocket', 'socket_id')
