...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NotebookSubscription'
        db.create_table('cotizador_notebooksubscription', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('notebook', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Notebook'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('email_notifications', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ))
        db.send_create_signal('cotizador', ['NotebookSubscription'])


    def backwards(self, orm):
        
        # Deleting model 'NotebookSubscription'
        db.delete_table('cotizador_notebooksubscription')
