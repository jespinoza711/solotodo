...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Notebook.week_discount'
        db.add_column('cotizador_notebook', 'week_discount', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Notebook.week_discount'
        db.delete_column('cotizador_notebook', 'week_discount')
