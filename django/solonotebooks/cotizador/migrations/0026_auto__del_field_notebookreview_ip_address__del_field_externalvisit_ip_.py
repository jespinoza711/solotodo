...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NotebookReview.ip_address'
        db.delete_column('cotizador_notebookreview', 'ip_address')

        # Deleting field 'ExternalVisit.ip_address'
        db.delete_column('cotizador_externalvisit', 'ip_address')

        # Deleting field 'StoreHasNotebook.visitorCount'
        db.delete_column('cotizador_storehasnotebook', 'visitorCount')


    def backwards(self, orm):
        
        # Adding field 'NotebookReview.ip_address'
        db.add_column('cotizador_notebookreview', 'ip_address', self.gf('django.db.models.fields.IPAddressField')(default='127.0.0.1', max_length=15), keep_default=False)

        # Adding field 'ExternalVisit.ip_address'
        db.add_column('cotizador_externalvisit', 'ip_address', self.gf('django.db.models.fields.IPAddressField')(default='127.0.0.1', max_length=15), keep_default=False)

        # Adding field 'StoreHasNotebook.visitorCount'
        db.add_column('cotizador_storehasnotebook', 'visitorCount', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
