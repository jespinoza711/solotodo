...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Product.similar_notebooks'
        db.rename_column('cotizador_product', 'similar_notebooks', 'similar_products')    
    
    def backwards(self, orm):
        
        db.rename_column('cotizador_product', 'similar_products', 'similar_notebooks')
