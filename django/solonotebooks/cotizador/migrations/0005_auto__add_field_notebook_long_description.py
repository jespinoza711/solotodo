...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Notebook.long_description'
        db.add_column('cotizador_notebook', 'long_description', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Notebook.long_description'
        db.delete_column('cotizador_notebook', 'long_description')
