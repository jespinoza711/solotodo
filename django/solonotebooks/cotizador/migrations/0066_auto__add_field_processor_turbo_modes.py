...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Processor.turbo_modes'
        db.add_column('cotizador_processor', 'turbo_modes', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=50), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Processor.turbo_modes'
        db.delete_column('cotizador_processor', 'turbo_modes')
