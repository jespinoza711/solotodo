...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NotebookChipsetBrand.brand'
        db.add_column('cotizador_notebookchipsetbrand', 'brand', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.InterfaceBrand']), keep_default=False)

        # Adding field 'NotebookOperatingSystemBrand.brand'
        db.add_column('cotizador_notebookoperatingsystembrand', 'brand', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.InterfaceBrand']), keep_default=False)

        # Adding field 'NotebookBrand.brand'
        db.add_column('cotizador_notebookbrand', 'brand', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.InterfaceBrand']), keep_default=False)

        # Adding field 'NotebookWifiCardBrand.brand'
        db.add_column('cotizador_notebookwificardbrand', 'brand', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.InterfaceBrand']), keep_default=False)

        # Adding field 'NotebookVideoCardBrand.brand'
        db.add_column('cotizador_notebookvideocardbrand', 'brand', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.InterfaceBrand']), keep_default=False)

        # Adding field 'VideoCardBrand.brand'
        db.add_column('cotizador_videocardbrand', 'brand', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.InterfaceBrand']), keep_default=False)

        # Adding field 'VideoCardGpuBrand.brand'
        db.add_column('cotizador_videocardgpubrand', 'brand', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.InterfaceBrand']), keep_default=False)

        # Adding field 'ScreenBrand.brand'
        db.add_column('cotizador_screenbrand', 'brand', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.InterfaceBrand']), keep_default=False)

        # Adding field 'ProcessorBrand.brand'
        db.add_column('cotizador_processorbrand', 'brand', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.InterfaceBrand']), keep_default=False)

        # Adding field 'NotebookProcessorBrand.brand'
        db.add_column('cotizador_notebookprocessorbrand', 'brand', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.InterfaceBrand']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NotebookChipsetBrand.brand'
        db.delete_column('cotizador_notebookchipsetbrand', 'brand_id')

        # Deleting field 'NotebookOperatingSystemBrand.brand'
        db.delete_column('cotizador_notebookoperatingsystembrand', 'brand_id')

        # Deleting field 'NotebookBrand.brand'
        db.delete_column('cotizador_notebookbrand', 'brand_id')

        # Deleting field 'NotebookWifiCardBrand.brand'
        db.delete_column('cotizador_notebookwificardbrand', 'brand_id')

        # Deleting field 'NotebookVideoCardBrand.brand'
        db.delete_column('cotizador_notebookvideocardbrand', 'brand_id')

        # Deleting field 'VideoCardBrand.brand'
        db.delete_column('cotizador_videocardbrand', 'brand_id')

        # Deleting field 'VideoCardGpuBrand.brand'
        db.delete_column('cotizador_videocardgpubrand', 'brand_id')

        # Deleting field 'ScreenBrand.brand'
        db.delete_column('cotizador_screenbrand', 'brand_id')

        # Deleting field 'ProcessorBrand.brand'
        db.delete_column('cotizador_processorbrand', 'brand_id')

        # Deleting field 'NotebookProcessorBrand.brand'
        db.delete_column('cotizador_notebookprocessorbrand', 'brand_id')
