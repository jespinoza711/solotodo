...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('cotizador_processorlinefamily', 'cotizador_notebookprocessorlinefamily')

        # Deleting model 'ProcessorLine'
        db.rename_table('cotizador_processorline', 'cotizador_notebookprocessorline')

        # Deleting model 'ProcessorBrand'
        db.rename_table('cotizador_processorbrand', 'cotizador_notebookprocessorbrand')

        # Deleting model 'ProcessorManufacturing'
        db.rename_table('cotizador_processormanufacturing', 'cotizador_notebookprocessormanufacturing')

        # Deleting model 'Processor'
        db.rename_table('cotizador_processor', 'cotizador_notebookprocessor')

        # Deleting model 'ProcessorCache'
        db.rename_table('cotizador_processorcache', 'cotizador_notebookprocessorcache')

        # Deleting model 'ProcessorSocket'
        db.rename_table('cotizador_processorsocket', 'cotizador_notebookprocessorsocket')

        # Deleting model 'ProcessorMultiplier'
        db.rename_table('cotizador_processormultiplier', 'cotizador_notebookprocessormultiplier')

        # Deleting model 'ProcessorFrequency'
        db.rename_table('cotizador_processorfrequency', 'cotizador_notebookprocessorfrequency')

        # Deleting model 'ProcessorFamily'
        db.rename_table('cotizador_processorfamily', 'cotizador_notebookprocessorfamily')

        # Deleting model 'ProcessorFSB'
        db.rename_table('cotizador_processorfsb', 'cotizador_notebookprocessorfsb')

        # Changing field 'Notebook.processor'
        db.alter_column('cotizador_notebook', 'processor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.NotebookProcessor']))
    
    
    def backwards(self, orm):
        
        # Deleting model 'ProcessorLineFamily'
        db.rename_table('cotizador_notebookprocessorlinefamily', 'cotizador_processorlinefamily')

        # Deleting model 'ProcessorLine'
        db.rename_table('cotizador_notebookprocessorline', 'cotizador_processorline')

        # Deleting model 'ProcessorBrand'
        db.rename_table('cotizador_notebookprocessorbrand', 'cotizador_processorbrand')

        # Deleting model 'ProcessorManufacturing'
        db.rename_table('cotizador_notebookprocessormanufacturing', 'cotizador_processormanufacturing')

        # Deleting model 'Processor'
        db.rename_table('cotizador_notebookprocessor', 'cotizador_processor')

        # Deleting model 'ProcessorCache'
        db.rename_table('cotizador_notebookprocessorcache', 'cotizador_processorcache')

        # Deleting model 'ProcessorSocket'
        db.rename_table('cotizador_notebookprocessorsocket', 'cotizador_processorsocket')

        # Deleting model 'ProcessorMultiplier'
        db.rename_table('cotizador_notebookprocessormultiplier', 'cotizador_processormultiplier')

        # Deleting model 'ProcessorFrequency'
        db.rename_table('cotizador_notebookprocessorfrequency', 'cotizador_processorfrequency')

        # Deleting model 'ProcessorFamily'
        db.rename_table('cotizador_notebookprocessorfamily', 'cotizador_processorfamily')

        # Deleting model 'ProcessorFSB'
        db.rename_table('cotizador_notebookprocessorfsb', 'cotizador_processorfsb')
        
        # Changing field 'Notebook.processor'
        db.alter_column('cotizador_notebook', 'processor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Processor']))
