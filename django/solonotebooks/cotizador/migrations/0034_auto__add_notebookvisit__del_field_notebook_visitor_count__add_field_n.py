...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NotebookVisit'
        db.create_table('cotizador_notebookvisit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('notebook', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Notebook'])),
        ))
        db.send_create_signal('cotizador', ['NotebookVisit'])

        # Deleting field 'Notebook.visitor_count'
        db.delete_column('cotizador_notebook', 'visitor_count')

        # Adding field 'Notebook.week_visitor_count'
        db.add_column('cotizador_notebook', 'week_visitor_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'NotebookVisit'
        db.delete_table('cotizador_notebookvisit')

        # Adding field 'Notebook.visitor_count'
        db.add_column('cotizador_notebook', 'visitor_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'Notebook.week_visitor_count'
        db.delete_column('cotizador_notebook', 'week_visitor_count')
