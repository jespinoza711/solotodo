...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProcessorL1CacheQuantity'
        db.create_table('cotizador_processorl1cachequantity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('cotizador', ['ProcessorL1CacheQuantity'])
        ...
        # Adding model 'ProcessorL1Cache'
        db.create_table('cotizador_processorl1cache', (
            ('multiplier', self.gf('django.db.models.fields.IntegerField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('quantity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.ProcessorL1CacheQuantity'])),
        ))
        db.send_create_signal('cotizador', ['ProcessorL1Cache'])
        ...
        db.create_table('cotizador_processorcore', (
            ('manufacturing_processs', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.ProcessorManufacturingProcess'])),
        ...
        db.create_table('cotizador_processor', (
            ...
            ('l1_cache', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.ProcessorL1Cache'])),
            ...
            ('has_vt', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ProcessorL1CacheQuantity'
        db.delete_table('cotizador_processorl1cachequantity')
        ...
        # Deleting model 'ProcessorL1Cache'
        db.delete_table('cotizador_processorl1cache')
    ...
    models = {
        ...
        'cotizador.processor': {
            ...
            'is_64_bit': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'l1_cache': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cotizador.ProcessorL1Cache']"}),
        ...
        'cotizador.processorcore': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manufacturing_processs': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cotizador.ProcessorManufacturingProcess']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        ...
        'cotizador.processorl1cache': {
            'Meta': {'object_name': 'ProcessorL1Cache'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'multiplier': ('django.db.models.fields.IntegerField', [], {}),
            'quantity': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cotizador.ProcessorL1CacheQuantity']"})
        },
        'cotizador.processorl1cachequantity': {
            'Meta': {'object_name': 'ProcessorL1CacheQuantity'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'value': ('django.db.models.fields.IntegerField', [], {})
        },
