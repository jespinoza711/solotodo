...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('cotizador_storagedrive', 'cotizador_notebookstoragedrive')

        # Deleting model 'VideoCardType'
        db.rename_table('cotizador_videocardtype', 'cotizador_notebookvideocardtype')

        # Deleting model 'VideoCard'
        db.rename_table('cotizador_videocard', 'cotizador_notebookvideocard')

        # Deleting model 'VideoCardBrand'
        db.rename_table('cotizador_videocardbrand', 'cotizador_notebookvideocardbrand')

        # Deleting model 'StorageDriveType'
        db.rename_table('cotizador_storagedrivetype', 'cotizador_notebookstoragedrivetype')

        # Deleting model 'VideoCardMemory'
        db.rename_table('cotizador_videocardmemory', 'cotizador_notebookvideocardmemory')

        # Deleting model 'VideoCardLine'
        db.rename_table('cotizador_videocardline', 'cotizador_notebookvideocardline')

        # Deleting model 'StorageDriveRpm'
        db.rename_table('cotizador_storagedriverpm', 'cotizador_notebookstoragedriverpm')

        # Deleting model 'StorageDriveCapacity'
        db.rename_table('cotizador_storagedrivecapacity', 'cotizador_notebookstoragedrivecapacity')
        
        # Mine
        
        db.rename_column('cotizador_notebook_storage_drive', 'storagedrive_id', 'notebookstoragedrive_id')        
        
        db.rename_column('cotizador_notebook_video_card', 'videocard_id', 'notebookvideocard_id')

    def backwards(self, orm):
        
        # Deleting model 'StorageDrive'
        db.rename_table('cotizador_notebookstoragedrive', 'cotizador_storagedrive')

        # Deleting model 'VideoCardType'
        db.rename_table('cotizador_notebookvideocardtype', 'cotizador_videocardtype')

        # Deleting model 'VideoCard'
        db.rename_table('cotizador_notebookvideocard', 'cotizador_videocard')

        # Deleting model 'VideoCardBrand'
        db.rename_table('cotizador_notebookvideocardbrand', 'cotizador_videocardbrand')

        # Deleting model 'StorageDriveType'
        db.rename_table('cotizador_notebookstoragedrivetype', 'cotizador_storagedrivetype')

        # Deleting model 'VideoCardMemory'
        db.rename_table('cotizador_notebookvideocardmemory', 'cotizador_videocardmemory')

        # Deleting model 'VideoCardLine'
        db.rename_table('cotizador_notebookvideocardline', 'cotizador_videocardline')

        # Deleting model 'StorageDriveRpm'
        db.rename_table('cotizador_notebookstoragedriverpm', 'cotizador_storagedriverpm')

        # Deleting model 'StorageDriveCapacity'
        db.rename_table('cotizador_notebookstoragedrivecapacity', 'cotizador_storagedrivecapacity')
        
        db.rename_column('cotizador_notebook_storage_drive', 'notebookstoragedrive_id', 'storagedrive_id')
        
        db.rename_column('cotizador_notebook_video_card', 'notebookvideocard_id', 'videocard_id')
