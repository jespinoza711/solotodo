...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Product.other'
        db.delete_column('cotizador_product', 'other')


    def backwards(self, orm):
        
        # Adding field 'Product.other'
        db.add_column('cotizador_product', 'other', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
