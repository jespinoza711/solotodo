...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StoreHasProductEntity.part_number'
        db.add_column('cotizador_storehasproductentity', 'part_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StoreHasProductEntity.part_number'
        db.delete_column('cotizador_storehasproductentity', 'part_number')
