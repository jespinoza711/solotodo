...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Advertisement.impressions'
        db.add_column('cotizador_advertisement', 'impressions', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Advertisement.impressions'
        db.delete_column('cotizador_advertisement', 'impressions')
