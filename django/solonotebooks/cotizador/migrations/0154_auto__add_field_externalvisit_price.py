...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ExternalVisit.price'
        db.add_column('cotizador_externalvisit', 'price', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ExternalVisit.price'
        db.delete_column('cotizador_externalvisit', 'price')
