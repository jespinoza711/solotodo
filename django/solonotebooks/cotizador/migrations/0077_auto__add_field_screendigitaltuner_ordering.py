...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScreenDigitalTuner.ordering'
        db.add_column('cotizador_screendigitaltuner', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ScreenDigitalTuner.ordering'
        db.delete_column('cotizador_screendigitaltuner', 'ordering')
