...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScreenSize.value'
        db.alter_column('cotizador_screensize', 'value', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=1))
    
    
    def backwards(self, orm):
        
        # Changing field 'ScreenSize.value'
        db.alter_column('cotizador_screensize', 'value', self.gf('django.db.models.fields.IntegerField')())
