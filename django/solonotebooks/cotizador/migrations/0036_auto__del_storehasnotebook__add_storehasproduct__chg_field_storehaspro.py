...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('cotizador_storehasnotebook', 'cotizador_storehasproduct')

        # Changing field 'StoreHasProductEntity.shn'
        db.alter_column('cotizador_storehasproductentity', 'shn_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.StoreHasProduct'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Adding model 'StoreHasNotebook'
        db.rename_table('cotizador_storehasproduct', 'cotizador_storehasnotebook')

        # Changing field 'StoreHasProductEntity.shn'
        db.alter_column('cotizador_storehasproductentity', 'shn_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.StoreHasNotebook'], null=True, blank=True))
