...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SponsoredVisit.date'
        db.alter_column('cotizador_sponsoredvisit', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'SponsoredVisit.date'
        db.alter_column('cotizador_sponsoredvisit', 'date', self.gf('django.db.models.fields.DateField')())
