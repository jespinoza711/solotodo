...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StoreHasNotebook.prevent_availability_change'
        db.add_column('cotizador_storehasnotebook', 'prevent_availability_change', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'StoreHasNotebookEntity.prevent_availability_change'
        db.delete_column('cotizador_storehasnotebookentity', 'prevent_availability_change')


    def backwards(self, orm):
        
        # Deleting field 'StoreHasNotebook.prevent_availability_change'
        db.delete_column('cotizador_storehasnotebook', 'prevent_availability_change')

        # Adding field 'StoreHasNotebookEntity.prevent_availability_change'
        db.add_column('cotizador_storehasnotebookentity', 'prevent_availability_change', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
