...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Advertisement.target_url'
        db.add_column('cotizador_advertisement', 'target_url', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Advertisement.target_url'
        db.delete_column('cotizador_advertisement', 'target_url')
