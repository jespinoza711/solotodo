...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProcessorCore.manufacturing_processs'
        db.rename_column('cotizador_processorcore', 'manufacturing_processs_id', 'manufacturing_process_id')

        # Adding field 'Processor.graphics'
        db.add_column('cotizador_processor', 'graphics', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.ProcessorGraphics']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.rename_column('cotizador_processorcore', 'manufacturing_process_id', 'manufacturing_processs_id')

        # Deleting field 'Processor.graphics'
        db.delete_column('cotizador_processor', 'graphics_id')
