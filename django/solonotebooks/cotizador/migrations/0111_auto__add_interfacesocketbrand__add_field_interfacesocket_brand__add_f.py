...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InterfaceSocket.brand'
        db.add_column('cotizador_interfacesocket', 'brand', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cotizador.InterfaceSocketBrand']), keep_default=False)

        # Adding field 'MotherboardChipset.name'
        db.add_column('cotizador_motherboardchipset', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'InterfaceSocket.brand'
        db.delete_column('cotizador_interfacesocket', 'brand_id')

        # Deleting field 'MotherboardChipset.name'
        db.delete_column('cotizador_motherboardchipset', 'name')
