...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'VideoCardBus.lane'
        db.delete_column('cotizador_videocardbus', 'lane_id')

        # Deleting field 'VideoCardBus.version'
        db.delete_column('cotizador_videocardbus', 'version')

        # Deleting field 'VideoCardBus.name'
        db.delete_column('cotizador_videocardbus', 'name_id')


    def backwards(self, orm):
        
        # Adding field 'VideoCardBus.lane'
        db.add_column('cotizador_videocardbus', 'lane', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.InterfaceCardBusLane']), keep_default=False)

        # Adding field 'VideoCardBus.version'
        db.add_column('cotizador_videocardbus', 'version', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=2, decimal_places=1), keep_default=False)

        # Adding field 'VideoCardBus.name'
        db.add_column('cotizador_videocardbus', 'name', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['cotizador.InterfaceCardBusName']), keep_default=False)
