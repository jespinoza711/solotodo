...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StoreHasProduct.shne'
        db.rename_column('cotizador_storehasproduct', 'shne_id', 'shpe_id')
    
    
    def backwards(self, orm):
        
        db.rename_column('cotizador_storehasproduct', 'shpe_id', 'shne_id')
