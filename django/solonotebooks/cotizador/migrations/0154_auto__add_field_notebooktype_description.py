...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NotebookType.description'
        db.add_column('cotizador_notebooktype', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NotebookType.description'
        db.delete_column('cotizador_notebooktype', 'description')
