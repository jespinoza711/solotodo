...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProcessorArchitecture.brand'
        db.add_column('cotizador_processorarchitecture', 'brand', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.ProcessorBrand']), keep_default=False)

        # Adding field 'Processor.has_unlocked_multiplier'
        db.add_column('cotizador_processor', 'has_unlocked_multiplier', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ProcessorArchitecture.brand'
        db.delete_column('cotizador_processorarchitecture', 'brand_id')

        # Deleting field 'Processor.has_unlocked_multiplier'
        db.delete_column('cotizador_processor', 'has_unlocked_multiplier')
