...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ComputerCase.has_motherboard_tray'
        db.add_column('cotizador_computercase', 'has_motherboard_tray', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ComputerCase.has_motherboard_tray'
        db.delete_column('cotizador_computercase', 'has_motherboard_tray')
