...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AdvertisementVisit.date'
        db.add_column('cotizador_advertisementvisit', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.date(2012, 9, 19), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AdvertisementVisit.date'
        db.delete_column('cotizador_advertisementvisit', 'date')
