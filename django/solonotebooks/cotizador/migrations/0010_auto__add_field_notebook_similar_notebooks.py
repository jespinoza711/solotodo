...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Notebook.similar_notebooks'
        db.add_column('cotizador_notebook', 'similar_notebooks', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Notebook.similar_notebooks'
        db.delete_column('cotizador_notebook', 'similar_notebooks')
