...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.ptype'
        db.alter_column('cotizador_product', 'ptype_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.ProductType'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Product.ptype'
        db.alter_column('cotizador_product', 'ptype_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.ProductType']))
