...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'StoreProductHistory', fields ['date']
        db.create_index('cotizador_storeproducthistory', ['date'])

        # Adding index on 'ExternalVisit', fields ['date']
        db.create_index('cotizador_externalvisit', ['date'])


    def backwards(self, orm):
        
        # Removing index on 'ExternalVisit', fields ['date']
        db.delete_index('cotizador_externalvisit', ['date'])

        # Removing index on 'StoreProductHistory', fields ['date']
        db.delete_index('cotizador_storeproducthistory', ['date'])
