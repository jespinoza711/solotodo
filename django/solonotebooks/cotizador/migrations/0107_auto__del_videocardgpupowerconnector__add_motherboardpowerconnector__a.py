...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cotizador_motherboard', (
            ...
            ('allows_raid', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('allows_sli', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('allows_cf', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ...
        db.create_table('cotizador_motherboardmemorytype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mtype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.InterfaceMemoryType'])),
        ))
