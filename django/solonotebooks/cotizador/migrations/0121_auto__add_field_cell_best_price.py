...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cell.best_price'
        db.add_column('cotizador_cell', 'best_price', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Cell.best_price'
        db.delete_column('cotizador_cell', 'best_price')
