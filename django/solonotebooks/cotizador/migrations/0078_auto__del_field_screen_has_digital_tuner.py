...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Screen.has_digital_tuner'
        db.delete_column('cotizador_screen', 'has_digital_tuner')
    
    
    def backwards(self, orm):
        
        # Adding field 'Screen.has_digital_tuner'
        db.add_column('cotizador_screen', 'has_digital_tuner', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
