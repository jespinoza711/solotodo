...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('cotizador_userprofile', 'facebook_id')

        # Adding field 'UserProfile.facebook_name'
        db.add_column('cotizador_userprofile', 'facebook_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'UserProfile.facebook_id'
        db.add_column('cotizador_userprofile', 'facebook_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Deleting field 'UserProfile.facebook_name'
        db.delete_column('cotizador_userprofile', 'facebook_name')
