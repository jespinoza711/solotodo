...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MotherboardFormat.format'
        db.add_column('cotizador_motherboardformat', 'format', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.InterfaceMotherboardFormat'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'MotherboardFormat.format'
        db.delete_column('cotizador_motherboardformat', 'format_id')
