...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Processor.l1_cache'
        db.delete_column('cotizador_processor', 'l1_cache_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Processor.l1_cache'
        db.add_column('cotizador_processor', 'l1_cache', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.ProcessorL1Cache']), keep_default=False)
