...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.can_access_competitivity_report'
        db.add_column('cotizador_userprofile', 'can_access_competitivity_report', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'UserProfile.can_use_extra_ordering_options'
        db.add_column('cotizador_userprofile', 'can_use_extra_ordering_options', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.can_access_competitivity_report'
        db.delete_column('cotizador_userprofile', 'can_access_competitivity_report')

        # Deleting field 'UserProfile.can_use_extra_ordering_options'
        db.delete_column('cotizador_userprofile', 'can_use_extra_ordering_options')
    ...
    models = {
        ...
        'cotizador.motherboardmemorytype': {
            'Meta': {'ordering': "['mtype']", 'object_name': 'MotherboardMemoryType'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'cotizador.screenresolution': {
            'Meta': {'ordering': "['total_pixels']", 'object_name': 'ScreenResolution'},
