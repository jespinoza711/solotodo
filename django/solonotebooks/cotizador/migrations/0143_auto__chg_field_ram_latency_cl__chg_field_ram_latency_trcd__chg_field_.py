...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ram.latency_cl'
        db.alter_column('cotizador_ram', 'latency_cl_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.RamLatencyCl'], null=True, blank=True))

        # Changing field 'Ram.latency_trcd'
        db.alter_column('cotizador_ram', 'latency_trcd_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.RamLatencyTrcd'], null=True, blank=True))

        # Changing field 'Ram.latency_trp'
        db.alter_column('cotizador_ram', 'latency_trp_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.RamLatencyTrp'], null=True, blank=True))

        # Changing field 'Ram.latency_tras'
        db.alter_column('cotizador_ram', 'latency_tras_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.RamLatencyTras'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Ram.latency_cl'
        db.alter_column('cotizador_ram', 'latency_cl_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.RamLatencyCl']))

        # Changing field 'Ram.latency_trcd'
        db.alter_column('cotizador_ram', 'latency_trcd_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.RamLatencyTrcd']))

        # Changing field 'Ram.latency_trp'
        db.alter_column('cotizador_ram', 'latency_trp_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.RamLatencyTrp']))

        # Changing field 'Ram.latency_tras'
        db.alter_column('cotizador_ram', 'latency_tras_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.RamLatencyTras']))
    ...
    models = {
        ...
        'cotizador.interfacememorybus': {
            'Meta': {'object_name': 'InterfaceMemoryBus'},
        ...
        'cotizador.interfacememoryformat': {
            'Meta': {'object_name': 'InterfaceMemoryFormat'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        ...
        'cotizador.ram': {
            'Meta': {'object_name': 'Ram', '_ormbases': ['cotizador.Product']},
        ...
        'cotizador.rambrand': {
            'Meta': {'object_name': 'RamBrand'},
            'brand': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cotizador.InterfaceBrand']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'cotizador.rambus': {
            'Meta': {'object_name': 'RamBus'},
        ...
        'cotizador.ramdimmcapacity': {
            'Meta': {'object_name': 'RamDimmCapacity'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'value': ('django.db.models.fields.IntegerField', [], {})
        },
        'cotizador.ramdimmquantity': {
            'Meta': {'object_name': 'RamDimmQuantity'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'value': ('django.db.models.fields.IntegerField', [], {})
        },
