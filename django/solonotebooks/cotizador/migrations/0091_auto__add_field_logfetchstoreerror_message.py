...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LogFetchStoreError.message'
        db.add_column('cotizador_logfetchstoreerror', 'message', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LogFetchStoreError.message'
        db.delete_column('cotizador_logfetchstoreerror', 'message')
