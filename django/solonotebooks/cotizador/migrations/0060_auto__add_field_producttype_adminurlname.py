...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductType.adminurlname'
        db.add_column('cotizador_producttype', 'adminurlname', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'ProductType.adminurlname'
        db.delete_column('cotizador_producttype', 'adminurlname')
