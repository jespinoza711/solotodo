...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.week_external_visits'
        db.add_column('cotizador_product', 'week_external_visits', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Product.display_name'
        db.add_column('cotizador_product', 'display_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.week_external_visits'
        db.delete_column('cotizador_product', 'week_external_visits')

        # Deleting field 'Product.display_name'
        db.delete_column('cotizador_product', 'display_name')
