...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MailChangeNotebookPrice'
        db.create_table('cotizador_mailchangenotebookprice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subscription', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.NotebookSubscription'])),
            ('log', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.LogChangeNotebookPrice'])),
            ('success', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ))
        db.send_create_signal('cotizador', ['MailChangeNotebookPrice'])


    def backwards(self, orm):
        
        # Deleting model 'MailChangeNotebookPrice'
        db.delete_table('cotizador_mailchangenotebookprice')
