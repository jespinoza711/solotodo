...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CellPricingTier.monthly_quota'
        db.add_column('cotizador_cellpricingtier', 'monthly_quota', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CellPricingTier.monthly_quota'
        db.delete_column('cotizador_cellpricingtier', 'monthly_quota')
