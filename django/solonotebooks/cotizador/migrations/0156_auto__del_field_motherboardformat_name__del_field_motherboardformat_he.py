...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MotherboardFormat.name'
        db.delete_column('cotizador_motherboardformat', 'name')

        # Deleting field 'MotherboardFormat.height'
        db.delete_column('cotizador_motherboardformat', 'height')

        # Deleting field 'MotherboardFormat.width'
        db.delete_column('cotizador_motherboardformat', 'width')


    def backwards(self, orm):
        
        # Adding field 'MotherboardFormat.name'
        db.add_column('cotizador_motherboardformat', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'MotherboardFormat.height'
        db.add_column('cotizador_motherboardformat', 'height', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'MotherboardFormat.width'
        db.add_column('cotizador_motherboardformat', 'width', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    ...
    models = {
        ...
        'cotizador.motherboardformat': {
            ...
            'format': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cotizador.InterfaceMotherboardFormat']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
