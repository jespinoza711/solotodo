...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VideoCard.speed_score'
        db.add_column('cotizador_videocard', 'speed_score', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Processor.speed_score'
        db.add_column('cotizador_processor', 'speed_score', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'VideoCard.speed_score'
        db.delete_column('cotizador_videocard', 'speed_score')

        # Deleting field 'Processor.speed_score'
        db.delete_column('cotizador_processor', 'speed_score')
