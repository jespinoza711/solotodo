...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Screen.digital_tuner'
        db.add_column('cotizador_screen', 'digital_tuner', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cotizador.ScreenDigitalTuner']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Screen.digital_tuner'
        db.delete_column('cotizador_screen', 'digital_tuner_id')
    ...
    models = {
        ...
        'cotizador.screen': {
            ...
            'has_digital_tuner': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
