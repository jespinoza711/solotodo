...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.shp'
        db.add_column('cotizador_product', 'shp', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='chosen_by', null=True, to=orm['cotizador.StoreHasProduct']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.shp'
        db.delete_column('cotizador_product', 'shp_id')
