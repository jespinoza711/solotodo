...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'StoreHasProduct.prevent_availability_change'
        db.delete_column('cotizador_storehasproduct', 'prevent_availability_change')

        # Adding field 'StoreHasProductEntity.prevent_availability_change'
        db.add_column('cotizador_storehasproductentity', 'prevent_availability_change', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'StoreHasProduct.prevent_availability_change'
        db.add_column('cotizador_storehasproduct', 'prevent_availability_change', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Deleting field 'StoreHasProductEntity.prevent_availability_change'
        db.delete_column('cotizador_storehasproductentity', 'prevent_availability_change')
