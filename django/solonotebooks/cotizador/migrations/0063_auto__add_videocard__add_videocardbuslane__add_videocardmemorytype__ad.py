...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'VideoCardBusLane'
        db.create_table('cotizador_videocardbuslane', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('cotizador', ['VideoCardBusLane'])
        ...
        # Adding model 'VideoCardBusName'
        db.create_table('cotizador_videocardbusname', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('show_version_and_lanes', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('cotizador', ['VideoCardBusName'])
        ...
        db.create_table('cotizador_videocardbus', (
            ('lane', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.VideoCardBusLane'])),
            ('version', self.gf('django.db.models.fields.DecimalField')(max_digits=2, decimal_places=1)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.VideoCardBusName'])),
        ))
        ...
        db.create_table('cotizador_videocardgpu', (
            ...
            ('has_multi_gpu_support', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ...
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('power_connectors', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.VideoCardGpuPowerConnector'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        ...
        # Adding model 'VideoCardGpuPowerConnector'
        db.create_table('cotizador_videocardgpupowerconnector', (
            ('ordering', self.gf('django.db.models.fields.IntegerField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('cotizador', ['VideoCardGpuPowerConnector'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'VideoCardBusLane'
        db.delete_table('cotizador_videocardbuslane')

        # Deleting model 'VideoCardMemoryType'
        db.delete_table('cotizador_videocardmemorytype')

        # Deleting model 'VideoCardBusName'
        db.delete_table('cotizador_videocardbusname')
        ...
        # Deleting model 'VideoCardGpuPowerConnector'
        db.delete_table('cotizador_videocardgpupowerconnector')
