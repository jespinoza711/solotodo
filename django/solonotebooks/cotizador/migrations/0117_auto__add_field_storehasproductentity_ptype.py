...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StoreHasProductEntity.ptype'
        db.add_column('cotizador_storehasproductentity', 'ptype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.ProductType'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StoreHasProductEntity.ptype'
        db.delete_column('cotizador_storehasproductentity', 'ptype_id')
