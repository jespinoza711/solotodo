...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cellphone.processor'
        db.alter_column('cotizador_cellphone', 'processor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.CellphoneProcessor'], null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Cellphone.processor'
        db.alter_column('cotizador_cellphone', 'processor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.CellphoneProcessor']))
