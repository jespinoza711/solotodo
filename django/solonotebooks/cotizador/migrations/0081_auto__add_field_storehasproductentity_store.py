...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StoreHasProductEntity.store'
        db.add_column('cotizador_storehasproductentity', 'store', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.Store']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StoreHasProductEntity.store'
        db.delete_column('cotizador_storehasproductentity', 'store_id')
