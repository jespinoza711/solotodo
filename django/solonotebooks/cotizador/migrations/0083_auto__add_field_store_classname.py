...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Store.classname'
        db.add_column('cotizador_store', 'classname', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Store.classname'
        db.delete_column('cotizador_store', 'classname')
