...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Screen.is_3d'
        db.alter_column('cotizador_screen', 'is_3d', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Screen.has_analog_tuner'
        db.alter_column('cotizador_screen', 'has_analog_tuner', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Cellphone.plays_mp3'
        db.alter_column('cotizador_cellphone', 'plays_mp3', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Cellphone.records_video'
        db.alter_column('cotizador_cellphone', 'records_video', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Cellphone.has_headphones_output'
        db.alter_column('cotizador_cellphone', 'has_headphones_output', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Cellphone.has_bluetooth'
        db.alter_column('cotizador_cellphone', 'has_bluetooth', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Cellphone.has_3g'
        db.alter_column('cotizador_cellphone', 'has_3g', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Cellphone.has_wifi'
        db.alter_column('cotizador_cellphone', 'has_wifi', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Cellphone.has_gps'
        db.alter_column('cotizador_cellphone', 'has_gps', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'CellPricingPlan.includes_data'
        db.alter_column('cotizador_cellpricingplan', 'includes_data', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'MailLostProduct.success'
        db.alter_column('cotizador_maillostproduct', 'success', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'NotebookScreen.is_led'
        db.alter_column('cotizador_notebookscreen', 'is_led', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'NotebookScreen.is_rotating'
        db.alter_column('cotizador_notebookscreen', 'is_rotating', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'NotebookScreen.is_glossy'
        db.alter_column('cotizador_notebookscreen', 'is_glossy', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'NotebookScreen.is_touchscreen'
        db.alter_column('cotizador_notebookscreen', 'is_touchscreen', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'MailChangeProductPrice.success'
        db.alter_column('cotizador_mailchangeproductprice', 'success', self.gf('django.db.models.fields.BooleanField')(blank=True))
        ...
        # Changing field 'StoreHasProductEntity.prevent_availability_change'
        db.alter_column('cotizador_storehasproductentity', 'prevent_availability_change', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'StoreHasProductEntity.is_available'
        db.alter_column('cotizador_storehasproductentity', 'is_available', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'StoreHasProductEntity.is_hidden'
        db.alter_column('cotizador_storehasproductentity', 'is_hidden', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Processor.has_unlocked_multiplier'
        db.alter_column('cotizador_processor', 'has_unlocked_multiplier', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Processor.has_vt'
        db.alter_column('cotizador_processor', 'has_vt', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Processor.is_64_bit'
        db.alter_column('cotizador_processor', 'is_64_bit', self.gf('django.db.models.fields.BooleanField')(blank=True))
        ...
        # Changing field 'Motherboard.allows_cf'
        db.alter_column('cotizador_motherboard', 'allows_cf', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Motherboard.allows_raid'
        db.alter_column('cotizador_motherboard', 'allows_raid', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Motherboard.allows_sli'
        db.alter_column('cotizador_motherboard', 'allows_sli', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'InterfaceCardBusName.show_version_and_lanes'
        db.alter_column('cotizador_interfacecardbusname', 'show_version_and_lanes', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'CellphoneScreen.is_touch'
        db.alter_column('cotizador_cellphonescreen', 'is_touch', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'UserProfile.can_access_competitivity_report'
        db.alter_column('cotizador_userprofile', 'can_access_competitivity_report', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'UserProfile.can_use_extra_ordering_options'
        db.alter_column('cotizador_userprofile', 'can_use_extra_ordering_options', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'NotebookProcessor.has_turbo_mode'
        db.alter_column('cotizador_notebookprocessor', 'has_turbo_mode', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'NotebookProcessor.has_smp'
        db.alter_column('cotizador_notebookprocessor', 'has_smp', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'ProductComment.validated'
        db.alter_column('cotizador_productcomment', 'validated', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'NotebookOperatingSystem.is_64_bit'
        db.alter_column('cotizador_notebookoperatingsystem', 'is_64_bit', self.gf('django.db.models.fields.BooleanField')(blank=True))
        ...
        # Changing field 'VideoCardGpu.has_multi_gpu_support'
        db.alter_column('cotizador_videocardgpu', 'has_multi_gpu_support', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'MailReviveProduct.success'
        db.alter_column('cotizador_mailreviveproduct', 'success', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'ProductSubscription.is_active'
        db.alter_column('cotizador_productsubscription', 'is_active', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'ProductSubscription.email_notifications'
        db.alter_column('cotizador_productsubscription', 'email_notifications', self.gf('django.db.models.fields.BooleanField')(blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Screen.is_3d'
        db.alter_column('cotizador_screen', 'is_3d', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Screen.has_analog_tuner'
        db.alter_column('cotizador_screen', 'has_analog_tuner', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Cellphone.plays_mp3'
        db.alter_column('cotizador_cellphone', 'plays_mp3', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Cellphone.records_video'
        db.alter_column('cotizador_cellphone', 'records_video', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Cellphone.has_headphones_output'
        db.alter_column('cotizador_cellphone', 'has_headphones_output', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Cellphone.has_bluetooth'
        db.alter_column('cotizador_cellphone', 'has_bluetooth', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Cellphone.has_3g'
        db.alter_column('cotizador_cellphone', 'has_3g', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Cellphone.has_wifi'
        db.alter_column('cotizador_cellphone', 'has_wifi', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Cellphone.has_gps'
        db.alter_column('cotizador_cellphone', 'has_gps', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'CellPricingPlan.includes_data'
        db.alter_column('cotizador_cellpricingplan', 'includes_data', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'MailLostProduct.success'
        db.alter_column('cotizador_maillostproduct', 'success', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'NotebookScreen.is_led'
        db.alter_column('cotizador_notebookscreen', 'is_led', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'NotebookScreen.is_rotating'
        db.alter_column('cotizador_notebookscreen', 'is_rotating', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'NotebookScreen.is_glossy'
        db.alter_column('cotizador_notebookscreen', 'is_glossy', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'NotebookScreen.is_touchscreen'
        db.alter_column('cotizador_notebookscreen', 'is_touchscreen', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'MailChangeProductPrice.success'
        db.alter_column('cotizador_mailchangeproductprice', 'success', self.gf('django.db.models.fields.BooleanField')())
        ...
        # Changing field 'StoreHasProductEntity.prevent_availability_change'
        db.alter_column('cotizador_storehasproductentity', 'prevent_availability_change', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'StoreHasProductEntity.is_available'
        db.alter_column('cotizador_storehasproductentity', 'is_available', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'StoreHasProductEntity.is_hidden'
        db.alter_column('cotizador_storehasproductentity', 'is_hidden', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Processor.has_unlocked_multiplier'
        db.alter_column('cotizador_processor', 'has_unlocked_multiplier', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Processor.has_vt'
        db.alter_column('cotizador_processor', 'has_vt', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Processor.is_64_bit'
        db.alter_column('cotizador_processor', 'is_64_bit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Processor.has_smp'
        db.alter_column('cotizador_processor', 'has_smp', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Motherboard.allows_cf'
        db.alter_column('cotizador_motherboard', 'allows_cf', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Motherboard.allows_raid'
        db.alter_column('cotizador_motherboard', 'allows_raid', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Motherboard.allows_sli'
        db.alter_column('cotizador_motherboard', 'allows_sli', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'InterfaceCardBusName.show_version_and_lanes'
        db.alter_column('cotizador_interfacecardbusname', 'show_version_and_lanes', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'CellphoneScreen.is_touch'
        db.alter_column('cotizador_cellphonescreen', 'is_touch', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'UserProfile.can_access_competitivity_report'
        db.alter_column('cotizador_userprofile', 'can_access_competitivity_report', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'UserProfile.can_use_extra_ordering_options'
        db.alter_column('cotizador_userprofile', 'can_use_extra_ordering_options', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'NotebookProcessor.has_turbo_mode'
        db.alter_column('cotizador_notebookprocessor', 'has_turbo_mode', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'NotebookProcessor.has_smp'
        db.alter_column('cotizador_notebookprocessor', 'has_smp', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'ProductComment.validated'
        db.alter_column('cotizador_productcomment', 'validated', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'NotebookOperatingSystem.is_64_bit'
        db.alter_column('cotizador_notebookoperatingsystem', 'is_64_bit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Advertisement.is_active'
        db.alter_column('cotizador_advertisement', 'is_active', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VideoCardGpu.has_multi_gpu_support'
        db.alter_column('cotizador_videocardgpu', 'has_multi_gpu_support', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'MailReviveProduct.success'
        db.alter_column('cotizador_mailreviveproduct', 'success', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'ProductSubscription.is_active'
        db.alter_column('cotizador_productsubscription', 'is_active', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'ProductSubscription.email_notifications'
        db.alter_column('cotizador_productsubscription', 'email_notifications', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'cotizador.storecustomupdateregistry': {
            'Meta': {'object_name': 'StoreCustomUpdateRegistry'},
        ...
        'cotizador.userprofile': {
            ...
            'can_access_competitivity_report': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'can_use_extra_ordering_options': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
