...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NotebookComment.ip_address'
        db.delete_column('cotizador_notebookcomment', 'ip_address')

        # Adding field 'NotebookComment.user'
        db.add_column('cotizador_notebookcomment', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Changing field 'NotebookComment.nickname'
        db.alter_column('cotizador_notebookcomment', 'nickname', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True))


    def backwards(self, orm):
        
        # Adding field 'NotebookComment.ip_address'
        db.add_column('cotizador_notebookcomment', 'ip_address', self.gf('django.db.models.fields.IPAddressField')(default='', max_length=15), keep_default=False)

        # Deleting field 'NotebookComment.user'
        db.delete_column('cotizador_notebookcomment', 'user_id')

        # Changing field 'NotebookComment.nickname'
        db.alter_column('cotizador_notebookcomment', 'nickname', self.gf('django.db.models.fields.CharField')(max_length=255))
