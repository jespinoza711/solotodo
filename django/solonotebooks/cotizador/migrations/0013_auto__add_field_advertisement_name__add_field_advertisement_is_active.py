...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Advertisement.name'
        db.add_column('cotizador_advertisement', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'Advertisement.is_active'
        db.add_column('cotizador_advertisement', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Advertisement.name'
        db.delete_column('cotizador_advertisement', 'name')

        # Deleting field 'Advertisement.is_active'
        db.delete_column('cotizador_advertisement', 'is_active')
