...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('cotizador_screen', 'cotizador_notebookscreen')

        # Deleting model 'RamFrequency'
        db.rename_table('cotizador_ramfrequency', 'cotizador_notebookramfrequency')

        # Deleting model 'ScreenSize'
        db.rename_table('cotizador_screensize', 'cotizador_notebookscreensize')

        # Deleting model 'ScreenSizeFamily'
        db.rename_table('cotizador_screensizefamily', 'cotizador_notebookscreensizefamily')

        # Deleting model 'RamQuantity'
        db.rename_table('cotizador_ramquantity', 'cotizador_notebookramquantity')

        # Deleting model 'RamType'
        db.rename_table('cotizador_ramtype', 'cotizador_notebookramtype')

        # Deleting model 'ScreenResolution'
        db.rename_table('cotizador_screenresolution', 'cotizador_notebookscreenresolution')

        # Changing field 'Notebook.ram_quantity'
        db.alter_column('cotizador_notebook', 'ram_quantity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.NotebookRamQuantity']))

        # Changing field 'Notebook.screen'
        db.alter_column('cotizador_notebook', 'screen_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.NotebookScreen']))

        # Changing field 'Notebook.ram_type'
        db.alter_column('cotizador_notebook', 'ram_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.NotebookRamType']))

        # Changing field 'Notebook.ram_frequency'
        db.alter_column('cotizador_notebook', 'ram_frequency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.NotebookRamFrequency']))
    
    
    def backwards(self, orm):
        
        # Deleting model 'Screen'
        db.rename_table('cotizador_notebookscreen', 'cotizador_screen')

        # Deleting model 'RamFrequency'
        db.rename_table('cotizador_notebookramfrequency', 'cotizador_ramfrequency')

        # Deleting model 'ScreenSize'
        db.rename_table('cotizador_notebookscreensize', 'cotizador_screensize')

        # Deleting model 'ScreenSizeFamily'
        db.rename_table('cotizador_notebookscreensizefamily', 'cotizador_screensizefamily')

        # Deleting model 'RamQuantity'
        db.rename_table('cotizador_notebookramquantity', 'cotizador_ramquantity')

        # Deleting model 'RamType'
        db.rename_table('cotizador_notebookramtype', 'cotizador_ramtype')

        # Deleting model 'ScreenResolution'
        db.rename_table('cotizador_notebookscreenresolution', 'cotizador_screenresolution')

        # Changing field 'Notebook.ram_quantity'
        db.alter_column('cotizador_notebook', 'ram_quantity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.RamQuantity']))

        # Changing field 'Notebook.screen'
        db.alter_column('cotizador_notebook', 'screen_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Screen']))

        # Changing field 'Notebook.ram_type'
        db.alter_column('cotizador_notebook', 'ram_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.RamType']))

        # Changing field 'Notebook.ram_frequency'
        db.alter_column('cotizador_notebook', 'ram_frequency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.RamFrequency']))
