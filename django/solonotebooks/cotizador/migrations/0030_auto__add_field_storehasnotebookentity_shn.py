...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StoreHasNotebookEntity.shn'
        db.add_column('cotizador_storehasnotebookentity', 'shn', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.StoreHasNotebook'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StoreHasNotebookEntity.shn'
        db.delete_column('cotizador_storehasnotebookentity', 'shn_id')
