...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProcessorMultiplier.value'
        db.alter_column('cotizador_processormultiplier', 'value', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=1))
    
    
    def backwards(self, orm):
        
        # Changing field 'ProcessorMultiplier.value'
        db.alter_column('cotizador_processormultiplier', 'value', self.gf('django.db.models.fields.IntegerField')())
