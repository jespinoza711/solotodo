...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Store.affiliate_id'
        db.add_column('cotizador_store', 'affiliate_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Store.affiliate_id'
        db.delete_column('cotizador_store', 'affiliate_id')
