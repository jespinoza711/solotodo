...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StoreHasProductEntity.date_added'
        db.add_column('cotizador_storehasproductentity', 'date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 4, 10), blank=True), keep_default=False)

        # Adding field 'StoreHasProductEntity.date_resolved'
        db.add_column('cotizador_storehasproductentity', 'date_resolved', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'StoreHasProductEntity.date_added'
        db.delete_column('cotizador_storehasproductentity', 'date_added')

        # Deleting field 'StoreHasProductEntity.date_resolved'
        db.delete_column('cotizador_storehasproductentity', 'date_resolved')
