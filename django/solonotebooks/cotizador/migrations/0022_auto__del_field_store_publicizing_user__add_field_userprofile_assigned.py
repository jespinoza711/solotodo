...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.assigned_store'
        db.add_column('cotizador_userprofile', 'assigned_store', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Store'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'UserProfile.assigned_store'
        db.delete_column('cotizador_userprofile', 'assigned_store_id')
