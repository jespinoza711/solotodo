...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cotizador_product', 'created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Adding field 'StoreHasProductEntity.resolved_by'
        db.add_column('cotizador_storehasproductentity', 'resolved_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.created_by'
        db.delete_column('cotizador_product', 'created_by_id')

        # Deleting field 'StoreHasProductEntity.resolved_by'
        db.delete_column('cotizador_storehasproductentity', 'resolved_by_id')
