...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Product.is_available'
        db.delete_column('cotizador_product', 'is_available')

        # Deleting field 'Product.min_price'
        db.delete_column('cotizador_product', 'min_price')


    def backwards(self, orm):
        
        # Adding field 'Product.is_available'
        db.add_column('cotizador_product', 'is_available', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Product.min_price'
        db.add_column('cotizador_product', 'min_price', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
