...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NotebookType.ordering'
        db.add_column('cotizador_notebooktype', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'NotebookType.screen_size'
        db.add_column('cotizador_notebooktype', 'screen_size', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'NotebookType.processor_speed'
        db.add_column('cotizador_notebooktype', 'processor_speed', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'NotebookType.processor_consumption'
        db.add_column('cotizador_notebooktype', 'processor_consumption', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'NotebookType.video_card_speed'
        db.add_column('cotizador_notebooktype', 'video_card_speed', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'NotebookType.storage_quantity'
        db.add_column('cotizador_notebooktype', 'storage_quantity', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'NotebookType.ram_quantity'
        db.add_column('cotizador_notebooktype', 'ram_quantity', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'Processor.consumption'
        db.add_column('cotizador_processor', 'consumption', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NotebookType.ordering'
        db.delete_column('cotizador_notebooktype', 'ordering')

        # Deleting field 'NotebookType.screen_size'
        db.delete_column('cotizador_notebooktype', 'screen_size')

        # Deleting field 'NotebookType.processor_speed'
        db.delete_column('cotizador_notebooktype', 'processor_speed')

        # Deleting field 'NotebookType.processor_consumption'
        db.delete_column('cotizador_notebooktype', 'processor_consumption')

        # Deleting field 'NotebookType.video_card_speed'
        db.delete_column('cotizador_notebooktype', 'video_card_speed')

        # Deleting field 'NotebookType.storage_quantity'
        db.delete_column('cotizador_notebooktype', 'storage_quantity')

        # Deleting field 'NotebookType.ram_quantity'
        db.delete_column('cotizador_notebooktype', 'ram_quantity')

        # Deleting field 'Processor.consumption'
        db.delete_column('cotizador_processor', 'consumption')
    ...
    models = {
        ...
        'cotizador.notebook': {
            ...
            'publicized_offer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'ntbk'", 'null': 'True', 'to': "orm['cotizador.StoreHasNotebook']"}),
