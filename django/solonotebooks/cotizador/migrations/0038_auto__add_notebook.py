...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cotizador_notebook', (
            ('power_adapter_2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.PowerAdapter'])),
            ('ram_quantity_2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.RamQuantity'])),
            ('has_bluetooth_2', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('chipset_2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Chipset'])),
            ('has_firewire_2', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('optical_drive_2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.OpticalDrive'])),
            ('lan_2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Lan'])),
            ('product_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cotizador.Product'], unique=True, primary_key=True)),
            ('card_reader_2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.NotebookCardReader'])),
            ('usb_port_count_2', self.gf('django.db.models.fields.IntegerField')()),
            ('battery_mwh_2', self.gf('django.db.models.fields.IntegerField')()),
            ('has_fingerprint_reader_2', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('webcam_mp_2', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=1)),
            ('height_2', self.gf('django.db.models.fields.IntegerField')()),
            ('battery_mah_2', self.gf('django.db.models.fields.IntegerField')()),
            ('line_2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.NotebookLine'])),
            ('width_2', self.gf('django.db.models.fields.IntegerField')()),
            ('ram_type_2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.RamType'])),
            ('screen_2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Screen'])),
            ('battery_cells_2', self.gf('django.db.models.fields.IntegerField')()),
            ('wifi_card_2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.WifiCard'])),
            ('is_ram_dual_channel_2', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('battery_mv_2', self.gf('django.db.models.fields.IntegerField')()),
            ('weight_2', self.gf('django.db.models.fields.IntegerField')()),
            ('ntype_2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.NotebookType'])),
            ('processor_2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.Processor'])),
            ('operating_system_2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.OperatingSystem'])),
            ('ram_frequency_2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.RamFrequency'])),
            ('has_esata_2', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('thickness_2', self.gf('django.db.models.fields.IntegerField')()),
        ))
