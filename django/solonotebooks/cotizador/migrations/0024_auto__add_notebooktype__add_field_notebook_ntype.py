...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Notebook.ntype'
        db.add_column('cotizador_notebook', 'ntype', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['cotizador.NotebookType']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('cotizador_notebook', 'ntype_id')
