...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'StoreHasNotebook.comparison_field'
        db.add_column('cotizador_storehasnotebook', 'comparison_field', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'StoreHasNotebook.comparison_field'
        db.delete_column('cotizador_storehasnotebook', 'comparison_field')
