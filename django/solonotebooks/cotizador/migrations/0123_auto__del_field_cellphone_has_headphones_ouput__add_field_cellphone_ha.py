...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Cellphone.has_headphones_ouput'
        db.delete_column('cotizador_cellphone', 'has_headphones_ouput')

        # Adding field 'Cellphone.has_headphones_output'
        db.add_column('cotizador_cellphone', 'has_headphones_output', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Cellphone.has_headphones_ouput'
        db.add_column('cotizador_cellphone', 'has_headphones_ouput', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Deleting field 'Cellphone.has_headphones_output'
        db.delete_column('cotizador_cellphone', 'has_headphones_output')
