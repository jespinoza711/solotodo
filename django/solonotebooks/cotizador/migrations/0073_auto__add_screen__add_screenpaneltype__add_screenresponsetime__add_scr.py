...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cotizador_screen', (
            ...
            ('has_digital_tuner', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ...
            ('is_3d', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('response_time', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cotizador.ScreenResponseTime'])),
            ('has_analog_tuner', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
