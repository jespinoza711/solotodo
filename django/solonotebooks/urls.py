...
urlpatterns += patterns('cotizador.views',
    ...
    (r'^allnotebooks/$', 'all_notebooks'),
    (r'^search/$', 'search'),
    (r'^ad_visited/(?P<advertisement_id>\d+)/$', 'ad_visited'),    
    (r'^comparison/$', 'notebook_comparison'),
    (r'^comparison/additem/$', 'add_item_notebook_comparison'),
    (r'^comparison/removeitem/$', 'remove_item_notebook_comparison'),
    (r'^comparison/(?P<comparison_id>\d+)/$', 'notebook_comparison_details'),
