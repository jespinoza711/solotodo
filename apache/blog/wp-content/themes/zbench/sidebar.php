<div id="sidebar-border">
	...
	<div id="rss"><a href="<?php if($options['rss_url'] <> '') { echo($options['rss_url']); } else { bloginfo('rss2_url'); } ?>" rel="nofollow" title="<?php _e('RSS Feed', 'zbench'); ?>"><?php _e('RSS Feed', 'zbench'); ?></a></div>
	<?php if($options['twitter_url'] <> '') : ?>
	<div id="twitter"><a href="<?php echo($options['twitter_url']); ?>" rel="nofollow" title="<?php _e('Follow me on twitter.', 'zbench'); ?>"><?php _e('Follow me on twitter.', 'zbench'); ?></a></div>
	<?php endif; ?>
	<?php if($options['facebook_url'] <> '') : ?>
	<div id="facebook"><a href="<?php echo($options['facebook_url']); ?>" rel="nofollow" title="<?php _e('Facebook', 'zbench'); ?>"><?php _e('Facebook', 'zbench'); ?></a></div>
	<?php endif; ?>
	<div id="sidebar">
